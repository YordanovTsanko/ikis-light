  ...
  return (
    <div className="min-h-screen text-white w-full bg-gradient-to-r from-primary to-black py-5 flex">
      <div className="flex items-center justify-center w-full max-w-[2000px] mx-auto">
        <div className="flex flex-col items-center justify-center space-y-3 px-16 text-center w-[400px]">
          <IoBusiness size={45} />
        ...
        <div className="flex flex-col items-center jutify-center bg-gray-200 w-full rounded-l-[140px]">
