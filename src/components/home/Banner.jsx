    ...
    <section className="relative text-white text-center flex h-[500px] lg:h-auto items-center justify-center px-2 lg:py-16 lg:px-6 sm:px-12 overflow-hidden">
      ...
      >
        ...
        <motion.p
          ...
          animate={{ scale: 1 }}
          transition={{ duration: 0.8, delay: 0.6 }}
          className="text-sm sm:text-md md:text-xl text-gray-200 mb-8 max-w-3xl mx-auto drop-shadow-md"
        >
          ...
          намиране на перфектните осветителни решения с <span className='text-primary'>AI</span> помощ за визуално
